...
<section class="mt-2 mb-5" id="cartDiv">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            @if (Auth::check() && $cartUsers && count($cartUsers) > 0 || Auth::check() && $cartPerso && count($cartPerso) > 0)
                <div class="col-12 col-lg-3 mt-3 mb-3">
                                ...
                                <div class="row border">
                                    ...
                                    <div class="col-3 d-flex flex-column align-items-center justify-content-center">
                                        <form action="/api/cart/quantity" method="post">
                                            ...
                                            <input type="number" class="form-control quantityForCalculate" name="quantityCart"
                                                min="1" max="10" id="quantityCart" value="{{ $produits->quantite }}">
                                            <input type="hidden" name="idProduct" id="idProduct"
                                                value="{{ $produits->product->ID }}">
                                                <input type="hidden" name="whoCart" value="normal">
                                            <button type="submit"
                                    ...
                                    <div class="col-3 d-flex flex-column justify-content-center align-items-center">
                                        <button class="btn bouton_style bouton_orange bouton_fond_blanc"
                                            onclick="removeFromCart('{{ $produits->ID }}', true, 'normal')">
                    ...
                    @endforeach
                    @foreach ($cartPerso as $produits)
                        <div class="mt-1 mb-1">
                            <div class="container">
                                <div class="row border">
                                    <div class="col-3 d-flex">
                                        <img src="<?php        echo asset('assets/personalize/frames/' . $produits->product->monture . '.jpg'); ?>"
                                            class="img-fluid w-100" alt="...">
                                    </div>
                                    <div class="col-3 d-flex flex-column align-items-start">
                                        <p class="fs-5 mt-1">Lunette personnaliser</p>
                                        <p class="fs-6"><span class="priceForCalculate">{{ $produits->product->prix }}</span> €
                                        </p>
                                    </div>
                                    <div class="col-3 d-flex flex-column align-items-center justify-content-center">
                                        <form action="/api/cart/quantity" method="post">
                                            ...
                                            <input type="hidden" name="idProduct" id="idProduct"
                                                value="{{ $produits->product->ID }}">
                                                <input type="hidden" name="whoCart" value="perso">
                                            <button type="submit"
                                    ...
                                    <div class="col-3 d-flex flex-column justify-content-center align-items-center">
                                        <button class="btn bouton_style bouton_orange bouton_fond_blanc"
                                            onclick="removeFromCart('{{ $produits->product->ID  }}', true, 'perso')">
                                            <img src="{{ asset('assets/dashboard/delete.png') }}" class="img-fluid" alt="..."
                                                width="25">
                                        </button>
                                    </div>
            ...
            @elseif  (Auth::check() && $cartUsers && count($cartUsers) == 0 || Auth::check() && $cartPerso && count($cartPerso) > 0)
                <div class="col-12 mt-4 d-flex flex-row justify-content-end justify-content-lg-center">
            ...
            @else
                <div class="col-12 mt-4 d-flex flex-row justify-content-end justify-content-lg-center">
                    <a href="{{ route('authentication') }}" class="btn bouton_style bouton_noir bouton_fond_orange">SE
                        CONNECTER POUR
                        PAYER</a>
                </div>
            @endif
